...
public class PivotTest : MonoBehaviour
{
    ...
    private void OnDrawGizmos()
    {
        ...
        Gizmos.DrawLine(this.offsetTranslation, (((Vector3) (quaternion * -this.pivot)) + this.pivot) + this.offsetTranslation);
    ...
    public void Update()
    {
        ...
        {
            Quaternion quaternion = Quaternion.Euler(this.pivotAngles);
            Vector3 vector = ((Vector3) (quaternion * -this.pivot)) + this.pivot;
